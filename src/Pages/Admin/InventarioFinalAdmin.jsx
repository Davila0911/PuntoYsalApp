...
import { getAdminInventory, saveAdminFinal } from "../../api/AdminApi";
...
function InventarioFinalAdmin({ tipoInventario }) {
  ...
  const handleGuardar = async (codigo, valor) => {
    ...
    try {
      await saveAdminFinal(codigo, value, tipoInventario);
      setGuardado((prev) => ({ ...prev, [codigo]: true }));
    } catch {
      alert("No se pudo guardar el conteo final.");
    }
  };
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Inventario Final - {tipoInventario}</h2>
            ...
            <table style={styles.table}>
              <thead>
                <tr style={styles.headerRow}>
                  ...
                  <th style={styles.th}>Conteo Final</th>
...
const styles = {
  ...
  btnGuardar: { color: "white", border: "none", borderRadius: "6px", padding: "6px 12px", cursor: "pointer", fontSize: "14px", transition: "background 0.3s ease" },
...
export default InventarioFinalAdmin;
